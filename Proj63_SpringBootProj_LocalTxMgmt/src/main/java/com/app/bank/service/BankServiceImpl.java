...
import com.app.bank.dao.BankDao;
...
public class BankServiceImpl implements BankService {
	...
	@Override
	@Transactional(propagation = Propagation.REQUIRED, readOnly = false, timeout = 10, rollbackFor = SQLException.class, transactionManager = "transactionManager")
