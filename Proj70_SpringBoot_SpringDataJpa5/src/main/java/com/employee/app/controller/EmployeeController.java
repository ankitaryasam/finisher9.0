...
public class EmployeeController {
    ...
    */
    ...
    public void getEmpData1(String city) {
    	empService.getEmpData1(city)
    					.forEach(viewData1->{
    						System.out.println(viewData1.getEid() + " " + viewData1.getName());
    					});
    	;
    }
    
    public void getEmpData2(String city) {
    	empService.getEmpData2(city)
    					.forEach(viewData2->{
    						System.out.println(viewData2.getEmail() + " " + viewData2.getSalary());
    					});
    	;
    }
    
    public void getEmpData3(String city) {
    	empService.getEmpData3(city)
    					.forEach(viewData3->{
    						System.out.println(viewData3.getEid() + " " + viewData3.getName() + " " + viewData3.getEmail());
    					});
    	;
    }
