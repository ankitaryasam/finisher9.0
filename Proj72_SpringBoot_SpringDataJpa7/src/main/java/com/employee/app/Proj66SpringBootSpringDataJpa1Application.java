...
public class Proj66SpringBootSpringDataJpa1Application {
	...
	controller.showEmployeeNamesByEidRange(1010, 1020);
	
	controller.updateEmployeeSalaryById(1001, 20000.00f);
	
	controller.removeEmployeeHavingNoAddress();
	
	controller.registerNewEmployee(9001, "amrit123@gmail.com", "Amritesh Verma", 90000.00f, "Patna");
	}
